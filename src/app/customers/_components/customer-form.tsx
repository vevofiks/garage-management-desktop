    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="phone" placeholder="+974 5555 5555" {...register("phone")} disabled={isSubmitting} />
        ...
        <div className="space-y-3 border-t pt-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => append({ vehicle_number: "", vehicle_model: "" })}
          ...
          <div className="space-y-3">
            {fields.map((field, index) => (
              <div key={field.id} className="flex items-start gap-2 rounded-md border p-3 bg-muted/20">
